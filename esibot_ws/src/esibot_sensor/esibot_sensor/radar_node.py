...
class EsibotSensorNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("servo_scan_angles_deg", [0.0, 15.0, 30.0])
        ...
        self.declare_parameter("servo_settle_time_sec", 0.7)
        self.declare_parameter("servo_min_pulse_width_sec", 0.0005)
        self.declare_parameter("servo_max_pulse_width_sec", 0.0025)
        ...
        self.servo_min_pulse_width_sec = float(
            self.get_parameter("servo_min_pulse_width_sec").value
        )
        self.servo_max_pulse_width_sec = float(
            self.get_parameter("servo_max_pulse_width_sec").value
        )
    ...
    def _setup_hardware(self) -> bool:
        ...
        try:
            self.servo = AngularServo(
                ...
                min_pulse_width=self.servo_min_pulse_width_sec,
                max_pulse_width=self.servo_max_pulse_width_sec,
            )
